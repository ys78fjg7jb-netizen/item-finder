...
import { Camera, MapPin, Tag, Palette, Check } from "lucide-react"
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    createItem.mutate({
      ...
      onSuccess: (data) => {
        toast({
          title: "Notice Posted",
          description: "Your item has been added to the school notice board.",
        })
      ...
      onError: () => {
        toast({
          title: "Error",
          description: "Could not post the notice. Please check your fields and try again.",
          variant: "destructive"
        })
      }
    })
              ...
              <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="relative">
                      <Palette size={16} className="absolute left-3 top-3 text-muted-foreground" />
                  ...
                  <div className="space-y-3 sm:col-span-2">
                    ...
                    <div className="relative">
                      <Tag size={16} className="absolute left-3 top-3 text-muted-foreground" />
                ...
                <div className="space-y-3">
                  ...
                  <Textarea 
                    ...
                    name="description" 
                    required 
                    placeholder={type === 'lost' ? "Describe any identifying marks, your name written inside, stickers, damage, or other details..." : "Describe the item clearly. You may leave out one detail to verify ownership."}
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative">
                    ...
                    <Input 
                      ...
                      required 
                      placeholder={type === 'lost' ? "e.g. Room 12, Science Lab, Canteen, Gym" : "e.g. Found in Room 5, near the library, sports field"} 
                      className="pl-9"
                    />
                  </div>
                </div>
                ...
                <div className="pt-6 border-t space-y-6">
                  ...
                  <p className="text-sm text-muted-foreground -mt-4">
                    Your contact info will be visible to other students and staff so they can reach you.
                  </p>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="space-y-3">
                      <Label htmlFor="reporterName">Your Name *</Label>
                      <Input id="reporterName" name="reporterName" required placeholder="e.g. Jamie Lee" />
                    </div>
                    <div className="space-y-3">
                      <Label htmlFor="reporterContact">School Email or Phone *</Label>
                      <Input id="reporterContact" name="reporterContact" required placeholder="e.g. jamie@school.edu" />
                    </div>
                  </div>
                </div>
